class NotificationManager {
    constructor(container = 'notification-container', customStyles = {}) {
    ...
    mergeStyles(defaultStyles, customStyles) {
        ...
        Object.keys(customStyles).forEach(key => {
            if (typeof customStyles[key] === 'object' && !Array.isArray(customStyles[key])) {
                merged[key] = this.mergeStyles(defaultStyles[key] || {}, customStyles[key]);
            } else {
    ...
    generateCSS() {
        ...
        return `
            ...
            ${Object.entries(currentStyles.types).map(([type, styles]) => `
                .notification-${type} {
