    ...
    t.prototype = {
        ...
        radius: function(t, i) {
            ...
            var a = this._circle = document.createElement("canvas"),
                s = a.getContext("2d"),
                e = this._r = t + i;
            return a.width = a.height = 10 * e, s.shadowOffsetX = s.shadowOffsetY = 10000, s.shadowBlur = i, s.shadowColor = "black", s.beginPath(), s.arc(e - 10000, e - 10000, t, 0, 2 * Math.PI, !0), s.closePath(), s.fill(), this
        },
        gradient: function(t) {
